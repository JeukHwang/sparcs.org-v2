<template>
    <div class="Members App__page">
        ...
        <transition-group class="Members__members" name="FadeMove" tag="div">
            <div class="Member" :class="`Member--height-${calculateHeight(member)}`" v-for="member in filteredMembers"
                :key="member.id">
                ...
                <div class="Member__links">
                    <a :href="getWebsite(member.website)" v-if="member.website" rel="noopener" target="_blank">

                        <IconWebsite />
                        {{ $t('website') }}
                    </a>

                    <a :href="getGithubLink(member.github_id)" v-if="member.github_id" rel="noopener" target="_blank">

                        <IconGithub />
                        {{ $t('github') }}
                    </a>

                    <a :href="getBehanceLink(member.behance_url)" v-if="member.behance_url" rel="noopener"
                        target="_blank">
                    ...
                    <a :href="getLinkedInLink(member.linkedin_url)" v-if="member.linkedin_url" rel="noopener"
                        target="_blank">
