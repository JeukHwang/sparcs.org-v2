        ...
        <div class="AppNavbar__content">
            ...
            <nav class="AppNavbar__items">
                <div class="AppNavbar__segment AppNavbar__bottom">
                    <router-link to="/seminars" class="AppNavbar__item" exact-active-class="AppNavbar__item--active">
                    ...
                    <router-link to="/members" class="AppNavbar__item" exact-active-class="AppNavbar__item--active">
                ...
                <div class="AppNavbar__segment AppNavbar__top">
                    <button class="AppNavbar__item" @click="login" v-if="!authState">
                        {{ $t('login') }}
                    </button>
...
export default {
    ...
    data: function () {
        return { authState: localStorage.getItem("isLogin") };
    },
    ...
    methods: {
        async login() {
         ...
         logout() {
            ...
            // location.reload();
            // believe no error? what is this code?
            // update logout
        }
    },
